...
6 clusters gives good results with hclusters
keep 6 clusters for this data
...
c1 <- feature.df_hclust[feature.df_hclust$Clustnumber==1,]
c2 <- feature.df_hclust[feature.df_hclust$Clustnumber==2,]
c3 <- feature.df_hclust[feature.df_hclust$Clustnumber==3,]
c4 <- feature.df_hclust[feature.df_hclust$Clustnumber==4,]
c5 <- feature.df_hclust[feature.df_hclust$Clustnumber==5,]
c6 <- feature.df_hclust[feature.df_hclust$Clustnumber==6,]
c7 <- feature.df_hclust[feature.df_hclust$Clustnumber==7,]
